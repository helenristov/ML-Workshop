...
// MAGIC 
// MAGIC -   ****Workspaces****
// MAGIC     -   Workspaces allow you to organize all the work that you are doing on Azure Databricks. Like a folder structure in your computer, it allows you to save ****notebooks**** and ****libraries**** and share them with other users. Workspaces are not connected to data and should not be used to store data. They're simply for you to store the ****notebooks**** and ****libraries**** that you use to operate on and manipulate your data with.
// MAGIC -   ****Notebooks****
...
// MAGIC %md
// MAGIC ##![Spark Logo Tiny](https://kpistoropen.blob.core.windows.net/collateral/roadshow/logo_spark_tiny.png) Azure Databricks Collaboration and traceability
// MAGIC 
// MAGIC ####Azure Databricks team work
// MAGIC * Updates in parallel
// MAGIC * Comments visible to all notebook members
// MAGIC 
// MAGIC ####Azure Databricks traceability
// MAGIC * Revision history + integration with Git
// MAGIC * Recent updates summary
...
// MAGIC ## Next Step
// MAGIC 
// MAGIC [Mounting Storage]($../1-Storage/1-01 Mounting Storage)
